...
// clang-format off KC_PSCR
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ansi_110(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_WSCH,  KC_WLCK,   KC_PSCR,  KC_SCRL, KC_PAUSE,   KC_CALC,  KC_MUTE,  KC_VOLD,  KC_VOLU,
    ...
    [_FN] = LAYOUT_ansi_110(
        _______,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FILE,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  _______,   _______,  KC_CTANA, RGB_TOG,   _______,  _______,  _______,  _______,
