...
// #if USB_SELECT_KEYCODE_ENABLE
// static indicator_config_t usb_connected_config     = USB_INDICATOR_CONFIG_CONNECTD;
// static indicator_config_t usb_not_connected_config = USB_INDICATOR_CONFIG_NOT_CONNECTED;
// #endif
...
#    define SET_LED_USB(idx) rgb_matrix_set_color(idx, 0, 0, 255)
...
bool    nkro_indicator_enable = false;
uint8_t indicator_nkro_count  = 0;

#    define indicator_nkro_number 3
#    define indicator_nkro_interval 250 // ms
#endif
...
#ifdef USB_INDICATION_LED_PIN
    setPinOutput(USB_INDICATION_LED_PIN);
    writePin(USB_INDICATION_LED_PIN, !BT_INDICATION_LED_ON_STATE);
#endif
...
#if defined(BT_INDICATION_LED_PIN_LIST) || defined(P24G_INDICATION_LED_PIN) || defined(COMMON_BT_LED_PIN) || defined(USB_INDICATION_LED_PIN)
    if (indicator_config.value) {
...
#if defined(BT_MODE_SELECT_PIN) || defined(P2P4_MODE_SELECT_PIN)
